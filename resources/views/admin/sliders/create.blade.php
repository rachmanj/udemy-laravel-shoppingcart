          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">New slider</h3>
              </div>
              ...
              <form action="{{ route('sliders.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label for="description11">Slider description 1</label>
                    <input type="text" name="description1" class="form-control" id="edescription1" placeholder="Enter slider description">
                  </div>
                  <div class="form-group">
