              ...
              <form action="{{ route('sliders.update', $slider->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="description1" class="form-control" id="description1" value="{{ old('description1', $slider->description1) }}">
                  </div>
                  <div class="form-group">
                    <label for="description2">Slider description 2</label>
                    <input type="text" name="description2" class="form-control" id="description2" value="{{ old('description2', $slider->description2) }}">
                  </div>
